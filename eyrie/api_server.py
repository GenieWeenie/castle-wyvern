    ...
    def _register_routes(self):
        ...
        def health():
            ...
            return jsonify({
                ...
                "version": "0.2.0",
                "services": {
                    "phoenix_gate": self.phoenix_gate.circuit_breakers["primary"].state.value,
                    "grimoorum": "active",
            ...
            return jsonify({
                "castle_wyvern": {
                    ...
                    "phoenix_gate": {
                        "primary": {
                            "provider": "z.ai",
                            "circuit_state": self.phoenix_gate.circuit_breakers["primary"].state.value
                        },
                        "fallback": {
                            "provider": "openai",
                            "circuit_state": self.phoenix_gate.circuit_breakers["fallback"].state.value
                        }
                    },
                    "clan": {
                        "total_members": 9,
            ...
            return jsonify({
                ...
                "members": [
                    {"id": "goliath", "name": "Goliath", "role": "Leader", 
                     "emoji": "🦁", "specialty": "High-level reasoning, orchestration"},
                    {"id": "lexington", "name": "Lexington", "role": "Technician", 
                     "emoji": "🔧", "specialty": "Code, automation, technical execution"},
                    {"id": "brooklyn", "name": "Brooklyn", "role": "Strategist", 
                     "emoji": "🎯", "specialty": "Multi-path planning, architecture"},
                    {"id": "broadway", "name": "Broadway", "role": "Chronicler", 
                     "emoji": "📜", "specialty": "Documentation, summarization"},
                    {"id": "hudson", "name": "Hudson", "role": "Archivist", 
                     "emoji": "📚", "specialty": "Historical context, long-term memory"},
                    {"id": "bronx", "name": "Bronx", "role": "Watchdog", 
                     "emoji": "🐕", "specialty": "Security monitoring, alerts"},
                    {"id": "elisa", "name": "Elisa", "role": "Bridge", 
                     "emoji": "🌉", "specialty": "Human context, ethics, legal"},
                    {"id": "xanatos", "name": "Xanatos", "role": "Red Team", 
                     "emoji": "🎭", "specialty": "Adversarial testing, vulnerabilities"},
                    {"id": "demona", "name": "Demona", "role": "Failsafe", 
                     "emoji": "🔥", "specialty": "Error prediction, worst-case scenarios"}
                ]
            })
