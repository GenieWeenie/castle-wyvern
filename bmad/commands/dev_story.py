...
def dev_story(story_description=None):
    ...
    implementation = wyvern.gate._call_zai(lexington_prompt, wyvern.spells["lexington"][:1000])
    ...
    docs = wyvern.gate._call_zai(broadway_prompt, wyvern.spells["broadway"][:1000])
