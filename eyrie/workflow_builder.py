...
class WorkflowTemplate:
    ...
    def bmad_full() -> Workflow:
        ...
        edges = [
            ...
            WorkflowEdge(id="e4", source="review", target="document", label="Approved", condition=None),
    ...
    def code_review_pipeline() -> Workflow:
        ...
        nodes = [
            WorkflowNode(
                id="start", type="start", name="Code Submitted",
                description="", position={"x": 100, "y": 200},
                data={}, config={}
            ),
            WorkflowNode(
                id="lexington", type="clan_member", name="Lexington Review",
            ...
            WorkflowNode(
                id="xanatos", type="clan_member", name="Xanatos Review",
            ...
            WorkflowNode(
                id="parallel", type="parallel", name="Parallel Reviews",
                description="Run reviews in parallel",
                position={"x": 500, "y": 200},
                data={}, config={}
            ),
            WorkflowNode(
                id="decision", type="decision", name="Approve?",
                description="Decision point",
                position={"x": 700, "y": 200},
                data={}, config={}
            ),
            WorkflowNode(
                id="merge", type="end", name="Merge",
                description="Code approved", position={"x": 900, "y": 100},
                data={}, config={}
            ),
            WorkflowNode(
                id="reject", type="end", name="Request Changes",
                description="Issues found", position={"x": 900, "y": 300},
                data={}, config={}
            )
        ]
        ...
        edges = [
            ...
            WorkflowEdge(id="e3", source="lexington", target="parallel", label=None, condition=None),
            ...
            WorkflowEdge(id="e6", source="decision", target="merge", label="Yes", condition="approved"),
            WorkflowEdge(id="e7", source="decision", target="reject", label="No", condition="rejected"),
        ]
    ...
    def security_audit() -> Workflow:
        ...
        nodes = [
            WorkflowNode(
                id="start", type="start", name="Start Audit",
                description="", position={"x": 100, "y": 100},
                data={}, config={}
            ),
            WorkflowNode(
                id="xanatos", type="clan_member", name="Xanatos Analysis",
            ...
            WorkflowNode(
                id="bronx", type="clan_member", name="Bronx Monitor",
            ...
            WorkflowNode(
                id="demona", type="clan_member", name="Demona Failsafe",
            ...
            WorkflowNode(
                id="report", type="clan_member", name="Broadway Report",
            ...
            WorkflowNode(
                id="end", type="end", name="Audit Complete",
                description="", position={"x": 1100, "y": 100},
                data={}, config={}
            )
        ]
...
class WorkflowManager:
    ...
    def list_workflows(self) -> List[Dict]:
        ...
        return [
            ...
            for wf in sorted(self.workflows.values(), 
