    ...
    def _setup_defaults(self):
        ...
        self.register_tool(
            ...
            input_schema={
                "type": "object",
                "properties": {
                    "question": {"type": "string", "description": "The question to ask Goliath"}
                },
                "required": ["question"],
            },
        ...
        self.register_tool(
            ...
            input_schema={
                "type": "object",
                "properties": {
                    "code": {"type": "string", "description": "Code to review for security issues"},
                    "description": {
                        "type": "string",
        ...
        self.register_tool(
            ...
            input_schema={
                "type": "object",
                "properties": {
                    "text": {"type": "string", "description": "Text to summarize or explain"},
                    "task": {
                        "type": "string",
...
6. Security considerations"""
    ...
    def register_resource(
        ...
        self.resources[uri] = MCPResource(
            uri=uri, name=name, description=description, mime_type=mime_type, handler=handler
        )

    def register_prompt(
        self, name: str, description: str, arguments: List[Dict], handler: Callable
    ):
    ...
    def get_capabilities(self) -> Dict:
        ...
        return {
            "serverInfo": {"name": "castle-wyvern-mcp", "version": "1.0.0"},
            "capabilities": {
    ...
    def call_tool(self, name: str, arguments: Dict) -> str:
        ...
        try:
            ...
            return json.dumps({"content": [{"type": "text", "text": result}], "isError": False})
    ...
    def read_resource(self, uri: str) -> str:
        ...
        return json.dumps(
            {"contents": [{"uri": uri, "mimeType": resource.mime_type, "text": resource.handler()}]}
        )
    ...
    async def handle_request(self, request: Dict) -> Dict:
        ...
        try:
            if method == "initialize":
                ...
                return {"jsonrpc": "2.0", "id": request_id, "result": json.loads(result)}
