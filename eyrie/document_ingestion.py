...
class SimpleEmbedding:
    ...
    def _build_vocabulary(self) -> Dict[str, int]:
        ...
        # Technology keywords
        tech_words = [
            "python", "javascript", "java", "rust", "go", "code", "function", "class",
            "api", "database", "sql", "server", "client", "http", "rest", "graphql",
            "security", "auth", "encrypt", "password", "token", "vulnerability",
        ...
        business_words = [
            ...
            "revenue", "cost", "profit", "market", "competitor",
            "team", "project", "milestone", "deadline", "sprint",
        ]
...
class DocumentIngestion:
    ...
    def _chunk_content(self, content: str, document_id: str, filename: str,
    ...
    def query_with_context(self, query: str, top_k: int = 3) -> str:
        ...
        for i, result in enumerate(results, 1):
            lines.append(f"### Source {i}: {result['document_name']} (relevance: {result['score']})")
