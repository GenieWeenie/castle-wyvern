...
class StoneNode:
    ...
    @classmethod
    def create(
        cls, name: str, host: str, port: int = 18790, capabilities: List[str] = None
    ) -> "StoneNode":
...
class NodeManager:
    ...
    def register_node(
        self, name: str, host: str, port: int = 18790, capabilities: List[str] = None
    ) -> str:
        """
    ...
    def update_node_status(self, node_id: str, status: NodeStatus, load: float = None):
