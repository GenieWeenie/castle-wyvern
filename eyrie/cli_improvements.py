...
class AutocompleteEngine:
    ...
    def get_completions(self, text: str) -> List[str]:
        ...
        matches = [
            cmd
            for cmd in self.commands + self.custom_completions
...
class ConfigWizard:
    ...
    def _load_config(self) -> Dict:
        ...
        defaults = {
            ...
            "ui": {"theme": "dark", "show_emojis": True, "compact_mode": False},
            "monitoring": {"enabled": True, "interval_seconds": 30, "alerts_enabled": True},
            "memory": {"max_entries": 10000, "auto_summarize": True},
        }
    ...
    def run_wizard(self, console):
        ...
        if Confirm.ask("Change primary AI provider?", default=False):
            ...
            choice = Prompt.ask(
                "Select provider", choices=[str(i) for i in range(1, len(providers) + 1)]
            )
