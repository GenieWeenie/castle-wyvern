...
class VectorMemoryStore:
    ...
    def search_similar(self, query: str, top_k: int = 5,
                       min_similarity: float = 0.5) -> List[Tuple[MemoryEmbedding, float]]:
        """
    ...
    def get_important_memories(self, min_importance: int = 4,
                               limit: int = 10) -> List[MemoryEmbedding]:
    ...
    def get_context_for_conversation(self, query: str,
                                     recent_limit: int = 3,
                                     similar_limit: int = 3) -> List[str]:
        """
    ...
    def consolidate_memories(self, age_days: int = 30,
    ...
    def get_stats(self) -> Dict:
        ...
        return {
            ...
            "consolidated": sum(1 for m in self.memories.values() 
                               if m.metadata.get("consolidated", False))
        }
...
class EnhancedGrimoorum:
    ...
    def add(self, content: str, doc_type: str = "note",
            metadata: Dict = None, importance: int = 3) -> str:
        """
    ...
    def get_stats(self) -> Dict:
        ...
        return {
            ...
            "original_memory": original_stats,
            "enhanced": True
        }
