...
class CastleWyvernLogger:
    ...
    def _setup_logging(self):
        ...
        self._setup_logger(
            "castle_wyvern.audit", self.log_dir / "audit.log", level=logging.INFO, json_format=True
        )
    ...
    def _setup_logger(
        self, name: str, log_file: Path, level: int = logging.INFO, json_format: bool = False
    ):
    ...
    def log_audit(self, event: str, user: str = None, details: Dict = None):
        ...
        audit_logger.info(
            event, extra={"extras": {"user": user, "event_type": "audit", "details": details or {}}}
        )
