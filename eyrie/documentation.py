...
class CodeAnalyzer:
    ...
    def _analyze_class(self, node: ast.ClassDef) -> ClassDoc:
        ...
        return ClassDoc(name=node.name, docstring=docstring, methods=methods, attributes=attributes)
...
class ArchitectureVisualizer:
    ...
    def add_component(self, name: str, component_type: str, description: str = ""):
        ...
        self.components.append({"name": name, "type": component_type, "description": description})

    def add_connection(self, from_component: str, to_component: str, connection_type: str = "uses"):
        """Add a connection between components."""
        self.connections.append(
            {"from": from_component, "to": to_component, "type": connection_type}
        )

    def generate_text_diagram(self) -> str:
        """Generate a text-based architecture diagram."""
        lines = ["# Castle Wyvern Architecture", "", "## Components", ""]
...
class ExampleGenerator:
    ...
    def add_example(self, title: str, description: str, code: str, output: str = ""):
        """Add an example."""
        self.examples.append(
            {"title": title, "description": description, "code": code, "output": output}
        )
